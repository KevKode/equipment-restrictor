...
public class EquipmentRestrictorPlugin extends Plugin
{
	...
	{
		log.info("Equipment Restrictor started!");
	}

	@Override
	protected void shutDown() throws Exception
	{
		log.info("Equipment Restrictor stopped!");
	}
	...
	public void onGameStateChanged(GameStateChanged gameStateChanged)
	{
		...
		{
			client.addChatMessage(ChatMessageType.GAMEMESSAGE, "", "Equipment Restrictor says " + config.greeting(), null);
		}
	}
